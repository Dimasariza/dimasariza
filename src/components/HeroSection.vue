<template>  
    <section class="relative w-full" data-aos="zoom-out-up" id="hero">
            ...
            <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
                <div class="lg:py-6">
                    ...
                    <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                        <!-- I am a passionate developer with 2 years of experience in web development and 1 year in game development. I specialize in creating user-friendly, responsive websites that help businesses solve problems and grow their online presence. I enjoy collaborating with clients to understand their needs and deliver tailored solutions. Let's build something great together! -->
                        I am passionate developer with 2 years of experience in creating engaging, interactive websites that help businesses grow and thrive in the digital world. I enjoy collaborating with clients to understand their needs and deliver tailored solutions that drive results.
                    </p>
                    <div class="flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0">
                        ...
                        <button class="border border-primary px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center">
                            <div class="hover:scale-105 transition-all ease-in-out flex justify-center items-center relative">
                                ...
                                <a href="/my_resume.pdf" download="resume.pdf" class="pl-2 text-primary"> Download resume</a>
                            </div>
                        </button>
                    </div>
                </div>
                <div class="lg:h-full md:flex">
                    <div class="flex w-full h-96 min-h-[24rem] lg:min-h-[none] lg:w-full lg:h-full items-center relative">
                        ...
                        <div class="absolute h-full z-10 p-2 -translate-y-1/2 top-1/2 lg:right-3 md:right-40 sm:right-16 rounded-full shadow-lg border border-primary">
                            <img src="@/assets/images/dimas profile 2.png" alt="Hero pic" width="900" height="auto" loading="lazy"
